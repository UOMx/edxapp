  ...
  if (typeof Backbone !== "undefined" && Backbone !== null) {
    this.DiscussionThreadView = (function(_super) {
      ...
      function DiscussionThreadView() {
        ...
        this.closeEditView = function(event) {
          return DiscussionThreadView.prototype.closeEditView.apply(_this, arguments);
        };
      ...
      DiscussionThreadView.prototype.initialize = function(options) {
        ...
        this.model.collection.on("reset", function(collection) {
          ...
          if (collection.get(id)) {
            return _this.model = collection.get(id);
          }
        });
        this.createShowView();
      ...
      DiscussionThreadView.prototype.loadResponses = function(responseLimit, elem, firstLoad) {
        ...
        return this.responsesRequest = DiscussionUtil.safeAjax({
          ...
          takeFocus: takeFocus,
          complete: function() {
            return _this.responsesRequest = null;
          },
          success: function(data, textStatus, xhr) {
            ...
            _this.loadedResponses = true;
            return _this.$el.find('.discussion-article[data-id="' + _this.model.id + '"]').focus();
          },
      ...
      DiscussionThreadView.prototype.closeEditView = function(event) {
        this.createShowView();
        this.renderShowView();
        this.renderAttrs();
