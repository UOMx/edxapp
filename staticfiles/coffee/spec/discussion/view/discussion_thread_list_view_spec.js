  ...
  describe("DiscussionThreadListView", function() {
    ...
    describe("should filter correctly", function() {
      return _.each(["all", "unread", "unanswered", "flagged"], function(filterVal) {
        return it("for " + filterVal, function() {
    ...
    describe("cohort selector", function() {
      ...
      return it("should allow moderators to select visibility", function() {
        var expectedGroupId,
          _this = this;
        ...
        return _.each([
          ...
          _this.view.$(".forum-nav-filter-cohort-control").val(optionInfo.val).change();
    ...
    describe("Sort change should be correct", function() {
      ...
      return it("with sort preference comments", function() {
        return changeSorting(this.threads, "votes", "comments", ["Thread1", "Thread4", "Thread3", "Thread2"]);
      });
    });
    ...
    describe("Search events", function() {
      ...
      return it("perform search when search icon is clicked", function() {
        setupAjax();
        spyOn(this.view, "searchFor");
    ...
    describe("post type renders correctly", function() {
      ...
      return it("for unanswered question", function() {
        renderSingleThreadWithProps({
          thread_type: "question",
          endorsed: false
        });
    ...
    return describe("browse menu", function() {
      ...
      return describe("selecting an item", function() {
        ...
        it("should get followed threads", function() {
          ...
          return expect($.ajax.mostRecentCall.args[0].data.group_id).toBeUndefined();
        });
