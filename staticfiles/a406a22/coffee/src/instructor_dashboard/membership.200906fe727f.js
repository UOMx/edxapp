...
(function() {
    ...
    AuthListWidget.prototype.reload_list = function() {
      ...
      return this.get_member_list(function(error, member_list) {
        ...
        return _.each(member_list, function(member) {
          ...
          $revoke_btn = $(_.template('<div class="revoke"><i class="icon fa fa-times-circle" aria-hidden="true"></i> <%= label %></div>')({
            label: label_trans
          }), {
            "class": 'revoke'
          });
  ...
  this.AutoEnrollmentViaCsv = (function() {
    ...
    AutoEnrollmentViaCsv.prototype.display_response = function(data_from_server) {
      var error, errors, general_error, render_response, result_from_server_is_success, warning, warnings, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2,
        _this = this;
      this.$results.empty();
      errors = [];
      warnings = [];
      ...
      if (data_from_server.general_errors.length) {
        ...
        _ref = data_from_server.general_errors;
      ...
      if (data_from_server.row_errors.length) {
        result_from_server_is_success = false;
        _ref1 = data_from_server.row_errors;
      ...
      if (data_from_server.warnings.length) {
        result_from_server_is_success = false;
        _ref2 = data_from_server.warnings;
      ...
      render_response = function(title, message, type, student_results) {
        var details, response_message, student_result, _l, _len3;
        details = [];
        for (_l = 0, _len3 = student_results.length; _l < _len3; _l++) {
          student_result = student_results[_l];
      ...
      if (result_from_server_is_success) {
        return render_response(gettext('Success'), gettext("All accounts were created successfully."), 'confirmation', []);
      }
    };
  ...
  BetaTesterBulkAddition = (function() {
    ...
    BetaTesterBulkAddition.prototype.display_response = function(data_from_server) {
      ...
      if (no_users.length) {
        ...
        return render_list(gettext("Could not find users associated with the following identifiers:"), (function() {
          var _j, _len1, _results;
          _results = [];
  ...
  BatchEnrollment = (function() {
    ...
    BatchEnrollment.prototype.display_response = function(data_from_server) {
      var allowed, autoenrolled, enrolled, errors, errors_label, invalid_identifier, notenrolled, notunenrolled, render_list, sr, student_results, _i, _j, _len, _len1, _ref,
        _this = this;
      this.clear_input();
      this.$task_response.empty();
      this.$request_response_error.empty();
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        } else if (data_from_server.action === 'unenroll' && !student_results.before.enrollment && !student_results.before.allowed) {
      ...
      if (allowed.length && emailStudents) {
        // Translators: A list of users appears after this sentence;
        render_list(gettext("Successfully sent enrollment emails to the following users. They will be allowed to enroll once they register:"), (function() {
          var _k, _len2, _results;
          _results = [];
      ...
      if (autoenrolled.length && emailStudents) {
        // Translators: A list of users appears after this sentence;
        render_list(gettext("Successfully sent enrollment emails to the following users. They will be enrolled once they register:"), (function() {
          var _k, _len2, _results;
          _results = [];
      ...
      if (notenrolled.length && emailStudents) {
        // Translators: A list of users appears after this sentence;
        render_list(gettext("Emails successfully sent. The following users are no longer enrolled in the course:"), (function() {
          var _k, _len2, _results;
          _results = [];
      ...
      if (notenrolled.length && !emailStudents) {
        // Translators: A list of users appears after this sentence;
        render_list(gettext("The following users are no longer enrolled in the course:"), (function() {
          var _k, _len2, _results;
          _results = [];
          for (_k = 0, _len2 = notenrolled.length; _k < _len2; _k++) {
            sr = notenrolled[_k];
      ...
      if (notunenrolled.length) {
        ...
        return render_list(gettext("These users were not affiliated with the course so could not be unenrolled:"), (function() {
          var _k, _len2, _results;
          _results = [];
  ...
  Membership = (function() {
    ...
    function Membership($section) {
      ...
      plantTimeout(0, function() {
        return new AutoEnrollmentViaCsv(_this.$section.find('.auto_enroll_csv'));
      });
      plantTimeout(0, function() {
