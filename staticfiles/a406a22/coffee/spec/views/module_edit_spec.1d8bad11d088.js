...
(function() {
  ...
  define(["jquery", "common/js/components/utils/view_utils", "js/spec_helpers/edit_helpers", "coffee/src/views/module_edit", "js/models/module_info", "xmodule"], function($, ViewUtils, edit_helpers, ModuleEdit, ModuleModel) {
    return describe("ModuleEdit", function() {
      beforeEach(function() {
        ...
        spyOn($, 'ajax').andReturn(this.moduleData);
        return this.moduleEdit = new ModuleEdit({
          el: $(".component"),
      ...
      return describe("methods", function() {
        ...
        describe("render", function() {
          ...
          it("loads inline css from fragments", function() {
            return expect($('head').append).toHaveBeenCalledWith("<style type='text/css'>inline-css</style>");
          });
          it("loads css urls from fragments", function() {
            return expect($('head').append).toHaveBeenCalledWith("<link rel='stylesheet' href='css-url' type='text/css'>");
          });
          ...
          return it("doesn't reload resources", function() {
            var count;
            ...
            return expect($('head').append.callCount).toBe(count);
          });
        });
        return describe("loadDisplay", function() {
          ...
          return it("loads the .xmodule-display inside the module editor", function() {
            ...
            return expect(XBlock.initializeBlock.mostRecentCall.args[0]).toBe($('.xblock-student_view'));
          });
        });
      });
    });
